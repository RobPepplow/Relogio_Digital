...
Agradecemos por visitar nosso projeto. Este é um exemplo simples de como utilizar os Metodos ja prontos do date(),que aqui foram utilizados os getHours()*Horas get Minutes()*Minutos e getSeconds()*Segundos , e utilizei para fazer a rotação do ponteiro de segundos o tranform: rotate ((segundos / 60) *360)deg)
